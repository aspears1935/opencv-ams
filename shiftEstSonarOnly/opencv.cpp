/*
 * Rotation and Translation Estimation with Sonar Data
 */

//To Do:
//"fixed" for precision?
//precision for linux time?
//Matches inliers image too?
//Create video of results?
//Make sure directions are right wrt vehicle
//Maybe change bad data from all zeros to last good result?
//LATER: Faster if don't recompute corners for past image
//MIGHT CONSIDER: Remove trackbar? Doen'st work - too slow
//FYI: changed how I open the video file - check make sure it works
//Deal with sensor angle? Maybe in post processing?
//Add in ability to put in truth data?
//Make SIFT/SURF/HARRIS have 1000 features
//Translate rotation from pixels to distance
//How to deal with resizing during run? For now, just ignore if different sizes
//Make sure all i=1 is changed to i=0
//Destroy all sonar objects
//Deal with SetRange()
