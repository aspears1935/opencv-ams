...
const char* edge_name = "Edge Detection";
  ...
  for( size_t i = 0; i < s_lines.size(); i++ )
    {
      ...
      line( standard_hough, pt1, pt2, Scalar(0,0,255), 3, 8);
    }
...
void Probabilistic_Hough( int, void* )
{
  ...
  for( size_t i = 0; i < p_lines.size(); i++ )
    {
      Vec4i l = p_lines[i];
      line( probabilistic_hough, Point(l[0], l[1]), Point(l[2], l[3]), Scalar(0,0,255), 3, 8);
    }
