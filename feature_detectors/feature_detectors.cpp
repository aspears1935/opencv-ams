                  ...
                  double ransacReprojThreshold, RNG& rng )
{
    ...
    if( !isWarpPerspective && ransacReprojThreshold >= 0 )
    {
        ...
        cout << ">" << endl;
	cout << "Homography " << endl << H12 << endl;
	std::vector<Point2f> debugPoints1(4);
	std::vector<Point2f> debugPoints2(4);
	debugPoints1[0] = Point(0,0);
	debugPoints1[1] = Point(0,1);
	debugPoints1[2] = Point(1,0);
	debugPoints1[3] = Point(1,1);
	perspectiveTransform(debugPoints1,debugPoints2,H12);
	cout << "Before: " << endl << debugPoints1 << endl;
	cout << "After: " << endl << debugPoints2 << endl;
    }
	...
	//AMS: Draw keypoints
	//Mat imgtemp = img1.clone();
	//drawKeypoints(imgtemp, keypoints1, imgtemp, Scalar(255,0,0));
	//imshow(winName, imgtemp);
	//waitKey(0);
...
int main(int argc, char** argv)
{
    ...
    clahe->apply(img1gray,img1);
    clahe->apply(img2gray,img2);
